...
class GenerateOneTestCaseScenario(Scenario):
    ...
    @classmethod
    def  query_prompt(cls, code) -> str:
        return f"The function code is: {code}"


    @staticmethod
    def class_generator(language: str):
        class_dict = {
...
class GenerateMulTestCaseScenario(Scenario):
    test_case_example = ""
    ...
    def mul_case_system_prompt(cls, language:str ) -> str:
        return f"""
               ...
               I will provide you with a code snippet. 
               First, make it static. 
               Then, write a main function with different test case to call this function to cover as many branches of the code snippet as possible.
    ...
    # You should write a main function at first.
    @classmethod
    def  query_prompt(cls, code) -> str:
        return f"The function code is: {code}"
